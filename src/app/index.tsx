...
export default function Index(){
  ...
  async function createTrip() {
    try {
      ...
      console.log("ESSE ERRO DO CREATE TRIP" ,error)
  ...
  async function getTrip() {
    try {
      ...
      console.log("ERRO NO GET TRIP ", error)
    }
  }
  ...
  return (
    <View className='flex-1 items-center justify-center px-5'>
        ...
        {stepForm === StepForm.ADD_EMAIL && (
          <>
            <View className='border-b py-3 border-zinc-800'>
              <Button variant='secundary' onPress={() => setStepForm(StepForm.TRIP_DETAILS)}>
      ...
      <Text className='text-zinc-500 font-regular text-center text-base'>
        Ao planejar sua viagem pela plann.er, você concorda automaticamente com nossos{" "}
